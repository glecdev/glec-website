        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold mb-8 animate-fade-in">
              ...
              Est. 2020 • ISO-14083 Based • SFC GLEC Tool 인증 진행 중
            </div>
              ...
              <>
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <p className="text-gray-600 leading-relaxed mb-4">
                      <strong className="text-gray-900">Smart Freight Centre GLEC Tool 인증</strong> 진행을 통해 글로벌 표준에 부합하는
                      솔루션을 제공합니다. ISO-14083 기반의 정확한 측정 방법론으로 국경을 넘는 복잡한 물류 경로의
                      탄소배출량도 신뢰성 있게 측정할 수 있습니다.
                    </p>
                    <p className="text-gray-600 leading-relaxed">
